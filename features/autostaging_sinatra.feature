Feature: Deploy Sinatra applications that make use of autostaging
  ...
  Background: Sinatra autostaging
    Given I have registered and logged in
      ...
      @creates_services @creates_sinatra_auto_reconfig_test_app
      ...
      @creates_services @creates_sinatra_amqp_auto_reconfig_app
	...
	Then I post rabbitabc to amqpoptions service with key abc
      ...
      @creates_services @creates_sinatra_auto_reconfig_unsupported_versions_app
      ...
      @creates_services @creates_sinatra_auto_reconfig_unsupported_carrot_version_app
      ...
      @creates_services @creates_sinatra_auto_reconfig_file_disable_app
      ...
      @creates_services @creates_sinatra_auto_reconfig_gem_disable_app
