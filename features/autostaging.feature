Feature: Deploy applications that make use of autostaging
  ...
  Background: MySQL and PostgreSQL autostaging
    Given I have registered and logged in
      ...
      @creates_jpa_app @creates_jpa_db_adapter @jvm @java @services
      ...
      @creates_hibernate_app @creates_hibernate_db_adapter @jvm @java @sanity @services
      ...
      @creates_roo_app @creates_roo_db_adapter @jvm @java @services
      ...
      @creates_hibernate_app @creates_hibernate_postgresql_adapter @jvm @java @sanity @services
      Scenario: start Spring Web application using Hibernate and add some records
      ...
      @creates_auto_reconfig_test_app @creates_services @jvm @java @services
      ...
      @creates_auto_reconfig_missing_deps_test_app @jvm @java
