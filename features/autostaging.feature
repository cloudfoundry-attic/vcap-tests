Feature: Deploy applications that make use of autostaging
  ...
  Background: MySQL and PostgreSQL autostaging
    Given I have registered and logged in
      ...
      @creates_jpa_app @creates_jpa_db_adapter @jvm
      ...
      @creates_hibernate_app @creates_hibernate_db_adapter @jvm @sanity
      ...
      @creates_grails_app @creates_grails_db_adapter @jvm
      ...
      @creates_roo_app @creates_roo_db_adapter @jvm
      ...
      @creates_rails3_app, @creates_rails3_db_adapter @ruby
      ...
      @creates_dbrails_app, @creates_dbrails_db_adapter @ruby @sanity
      ...
      @creates_hibernate_app @creates_hibernate_postgresql_adapter @jvm @sanity
      Scenario: start Spring Web application using Hibernate and add some records
      ...
      @creates_auto_reconfig_test_app @creates_services @jvm
      ...
      @creates_auto_reconfig_missing_deps_test_app @jvm
