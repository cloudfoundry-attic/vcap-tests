...
Feature: Standalone application support
  ...
  Scenario: With no runtime
    Given I have deployed a standalone application named standalone_simple_script_app
    When I query status of my application
    Then I should get the state of my application
    Then I should be able to access my application file logs/stdout.log and see I'm a simple script
    When I delete my application
    Then it should not be on Cloud Foundry
