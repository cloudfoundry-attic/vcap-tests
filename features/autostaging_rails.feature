Feature: Deploy Rails applications that make use of autostaging
  ...
  Background: Rails autostaging
    Given I have registered and logged in
      ...
      @creates_services @creates_rails_auto_reconfig_test_app
	...
	When I provision postgresql service
      ...
      @creates_services @creates_rails_auto_reconfig_file_disable_app
      ...
      @creates_services @creates_rails_auto_reconfig_gem_disable_app
